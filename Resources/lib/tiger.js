...
(function() {
  ...
  Spine = this.Spine || require('/lib/spine');
  ...
  Ajax = (function(_super) {
    ...
    Ajax.download = function(options) {
      ...
      options.onload = function(xhr) {
        var f;
        if (xhr.responseData == null) return;
    ...
    function Ajax(options) {
      var header, name, xhr, _debug, _ref,
        _this = this;
      ...
      if (options.file) xhr.file = options.file;
  ...
  Controller = (function(_super) {
    ...
    Controller.prototype.mapSelector = function(selector) {
      ...
      if (el = this._map[selector]) return el;
    ...
    Controller.prototype.delegateEvents = function() {
      var el, eventName, key, match, method, methodName, selector, _ref;
      _ref = this.events;
      for (key in _ref) {
        methodName = _ref[key];
    ...
    Controller.prototype.loadSynced = function() {
      var el, field, prop, props, selector, selectors, value, _ref;
      _ref = this.map;
      for (field in _ref) {
        selector = _ref[field];
        if (__indexOf.call(selector, '.') >= 0) {
